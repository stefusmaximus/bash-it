...
MACHINE_INFO_THEME_PROMPT_COLOR=57
MACHINE_INFO_THEME_PROMPT_COLOR_SUDO=52
...
POWERLINE_PROMPT=${POWERLINE_PROMPT:="machine_info user_info scm python_venv ruby node cwd"}
